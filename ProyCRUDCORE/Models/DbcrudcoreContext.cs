...
public partial class DbcrudcoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCargo).HasName("PK__CARGO__6C985625B08276AB");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__EMPLEADO__CE6D8B9E886D9E43");
